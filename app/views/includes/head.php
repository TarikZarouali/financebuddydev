...
<body>
    <!-- start mobile header -->
    <header
        class="position-sticky top-0 z-index-header bg shadow-xs padding-x-component padding-y-sm flex items-center justify-between hide@md">
    ...
    <div class="flex@md">
        <aside id="cms-main-sidebar" class="sidebar sidebar--static@md js-sidebar"
            ...
            <div class="sidebar__panel flex-grow flex flex-column">
                ...
                <header
                    class="sidebar__header bg padding-y-sm padding-left-md padding-right-sm border-bottom z-index-2">
                ...
                <header class="display@md padding-x-xs margin-bottom-lg">
                    <div class="flex items-center justify-between height-60 padding-right-xs padding-left-xxxs">
                        ...
                        <a class="inline-flex color-contrast-high hover:reduce-opacity js-tooltip-trigger"
                            title="Launch website" href="https://codyhouse.co/template/nettuno" target="_blank">
                            <svg class="icon icon--xs" viewBox="0 0 16 16">
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2">
                                    <path
                                        d="M15,12v1.5A1.5,1.5,0,0,1,13.5,15H2.5A1.5,1.5,0,0,1,1,13.5V2.5A1.5,1.5,0,0,1,2.5,1H4" />
                        ...
                        <ul>
                                    ...
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M16 12v7H4v-7"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M1 10l9-9 9 9"></path>
                            ...
                            <li class="sidenav-v4__item">
                                <a class="sidenav-v4__link js-sidenav-v4__link" href="articles.html">
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <path d="M3 1h10l5 5v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"
                                                fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"></path>
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="2" d="M13 1l5 5h-5V1z"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M6 6h2"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M6 10h8"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M6 14h8"></path>
                                        </g>
                                    </svg>
                                    ...
                                    <svg class="sidenav-v4__arrow-icon icon margin-left-auto" viewBox="0 0 20 20">
                                        <g class="icon__group" fill="none" stroke="currentColor" stroke-width="2px"
                            ...
                            <li class="sidenav-v4__item">
                                <a class="sidenav-v4__link js-sidenav-v4__link" href="reports.html">
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M4.231 11L7 5l6 5 6-8">
                                            </path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M1 18l1.385-3"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M1 11h4l8 6 6-5"></path>
                                        </g>
                                    </svg>
                                    ...
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <rect x="2" y="2" width="16" height="16" rx="2" fill="none"
                                                ...
                                                stroke-width="2"></rect>
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="2" d="M6 14l6-6 2 6H6z"></path>
                            ...
                            <li class="sidenav-v4__item">
                                <a class="sidenav-v4__link js-sidenav-v4__link" href="users.html">
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <circle cx="10" cy="4" r="3" fill="none" stroke="currentColor"
                                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                            </circle>
                                            <path
                                                d="M10 11a8 8 0 0 0-7.562 5.383A2 2 0 0 0 4.347 19h11.306a2 2 0 0 0 1.909-2.617A8 8 0 0 0 10 11z"
                                                fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"></path>
                                        </g>
                                    </svg>
                                    ...
                                    <svg class="sidenav-v4__icon icon" viewBox="0 0 20 20">
                                        <g fill="currentColor">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                ...
                                                d="M14 2H6l-5 8 5 8h8l5-8-5-8z"></path>
                                            <circle cx="10" cy="10" r="3" fill="none" stroke="currentColor"
                                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                            </circle>
                                        </g>
                                    </svg>
                    ...
                    <div class="padding-x-xs padding-bottom-sm hide@md">
                        <div class="padding-x-sm">
                            <div class="search-input search-input--icon-left text-md">
                                <input class="search-input__input form-control" type="search" name="search-input"
                ...
                <footer
                    class="sidebar__footer border-top border-alpha padding-xs margin-top-auto position-sticky bottom-0 z-index-1">
                    <div class="padding-x-xs flex items-center justify-between">
                        <label class="" for="select-theme">Theme:</label>

                        <div class="select text-sm"
                            style="--select-icon-right-margin: var(--space-xxs); --select-icon-size: 12px;">
                            <select class="select__input btn btn--subtle padding-x-xxs padding-y-xxxs"
                                name="select-theme" id="select-theme">
        ...
        <main
            class="position-relative z-index-1 flex-grow min-height-100vh position-sticky@md top-0@md height-100vh@md overflow-auto@md sidebar-loaded:show">
            <!-- start main content -->

            <!-- start desktop main header -->
            <header
                class="position-sticky top-0 z-index-header bg bg-opacity-80% border-bottom border-alpha backdrop-blur-10 display@md">
                <div class="height-60 flex items-center justify-between padding-x-component">
                    <div class="search-input search-input--icon-left position-relative width-100% max-width-xxxxs autocomplete js-autocomplete"
                        data-autocomplete-dropdown-visible-class="autocomplete--results-visible">
                        <form action="search-results.html">
                            <input autocomplete="off"
                                class="search-input__input form-control js-autocomplete__input js-search-input"
                                type="search" name="search-input" id="search-input" placeholder="Search..."
                                aria-label="Search">

                            <button class="search-input__btn">
                                <svg class="icon" viewBox="0 0 16 16">
                                    <title>Submit</title>
                                    <circle cx="6.5" cy="6.5" r="4.5" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                    <line x1="14" y1="14" x2="10" y2="10" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                </svg>
                            </button>
                        </form>
                        ...
                        <div class="autocomplete__loader position-absolute top-0 right-0 padding-right-xxs height-100% flex items-center"
                            aria-hidden="true">
                        ...
                        <div class="autocomplete__results js-autocomplete__results">
                            <ul id="autocomplete1" class="autocomplete__list js-autocomplete__list">
                                <li class="autocomplete__item js-autocomplete__item is-hidden">
                                    <a data-autocomplete-url
                                        class="text-decoration-none color-contrast-higher block padding-y-xs padding-x-sm autocomplete__link">
                                        <span class="block" data-autocomplete-label></span>
                                        <span class="block text-xs color-contrast-medium margin-top-xxxxs"
                                            data-autocomplete-category></span>
                                    </a>
                                </li>
                            </ul>
                        </div>

                        <p class="sr-only" aria-live="polite" aria-atomic="true"><span
                                class="js-autocomplete__aria-results">0</span> results found.</p>
                    </div>
                    ...
                    <button class="reset user-menu-control" aria-controls="user-menu" aria-label="Toggle user menu">
                        <figure class="user-menu-control__img-wrapper radius-50%">
                            <img class="user-menu-control__img" src="<?= URLROOT ?>assets/img/author-img-1.jpg"
                                alt="User picture">
                        </figure>

                        <div class="margin-x-xs user-menu__meta">
                            <p
                                class="user-menu__meta-title text-sm line-height-1 padding-y-xxxxs font-semibold color-contrast-higher text-truncate">
                                Emily Ewing</p>
