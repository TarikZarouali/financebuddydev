...
<body class="bg-dark min-height-100vh flex flex-center padding-md">
    <form class="bg radius-md shadow-sm padding-lg max-width-xxs" id="registrationForm" onsubmit="signUp(event)"
        method="POST" action="<?= URLROOT ?>user/register">
        ...
        <div class="margin-bottom-sm">
            <div class="grid gap-xs">
                <div class="col-6@md">
                    ...
                    <input class="form-control width-100%" type="text" name="userFirstName" id="js-FirstName"
                        placeholder="John">
                </div>

                <div class="col-6@md">
                    <label class="form-label margin-bottom-xxxs" for="userLastName">Last name</label>
                    <input class="form-control width-100%" type="text" name="userLastName" id="js-LastName"
                        placeholder="Doe">
                </div>
            </div>
        </div>
        ...
        <div class="margin-bottom-sm">
            ...
            <input class="form-control width-100%" type="text" name="userUserName" id="js-UserName">
        </div>

        <div class="margin-bottom-sm">
            <label class="form-label margin-bottom-xxxs" for="userEmail">Email</label>
            <input class="form-control width-100%" type="email" name="userEmail" id="js-Email"
