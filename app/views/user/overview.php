...
<body>
                    ...
                    <div class="dropdown inline-block js-dropdown">
                        <div class="dropdown__wrapper">
                            ...
                            <ul class="dropdown__menu js-dropdown__menu" aria-label="dropdown">
                                <li>
                                    <a class="dropdown__item" href="<?= 'user/password' ?>">Settings</a>
                                </li>

                                <li>
                                    <a class="dropdown__item" href="<?= URLROOT . 'user/password' ?>">Password</a>
                                </li>
                                ...
                                <li>
                                    <a class="dropdown__item" href="<?= URLROOT . 'user/logout' ?>">Log Out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class="sidenav__list">
                            ...
                            <li class="sidenav__item sidenav__item--expanded">
                                ...
                                <ul class="sidenav__list">
                                    ...
                                    <li class="sidenav__item">
                                        <a href="customers.html" class="sidenav__link" aria-current="page">
                ...
                <div class="flex flex-wrap gap-sm items-center justify-between">
                    <div>
                        <div class="flex flex-wrap gap-xxs">
                            <div class="select">
                                <select class="select__input form-control line-height-xs">
                                    <option value="0">All Users</option>
                                    <option value="1">Free Users</option>
                                    <option value="custom">Pro Users</option>
                                </select>
                    ...
                    <button class="btn btn--primary" aria-controls="modal-new-customer">
                        + New User
                    </button>
                </div>
            </div>
                        ...
                        <table class="int-table__table" aria-label="Interactive table example">
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <th
                                        ...
                                        <ul class="sr-only js-int-table__sort-list">
                                            ...
                                            <li>
                                                <input type="radio" name="sortingName" id="sortingNameAsc"
                                                    value="asc" />
                                                <label for="sortingNameAsc">Sort in ascending order</label>
                                            </li>

                                            <li>
                                                <input type="radio" name="sortingName" id="sortingNameDes"
                                                    value="desc" />
                                    ...
                                    <th class="int-table__cell int-table__cell--th int-table__cell--sort js-int-table__cell--sort"
                                        ...
                                        <ul class="sr-only js-int-table__sort-list">
                                            ...
                                            <li>
                                                <input type="radio" name="sortingDate" id="sortingDateAsc"
                                                    value="asc" />
                                                <label for="sortingDateAsc">Sort in ascending order</label>
                                            </li>

                                            <li>
                                                <input type="radio" name="sortingDate" id="sortingDateDes"
                                                    value="desc" />
                                    ...
                                    <th class="int-table__cell int-table__cell--th text-right">
                                        Action
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="int-table__body js-int-table__body">
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Hetty Maxwell</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Honey Leblanc</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Maira Hodges</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Nigel Lang</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Saif Acevedo</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Isaak O'Gallagher</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Lucille Arias</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Kendall Rankin</a>
                                    </td>
                                ...
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="customer.html">Raihan Boone</a>
                                    </td>
            ...
            <li class="notif__item">
                <a class="notif__link flex padding-sm" href="#0">
                    ...
                    <div class="flex-grow margin-right-xs">
                        <div>
                            <p>
                                <i class="font-semibold">Olivia Saturday</i> commented on your
                                <i class="font-semibold">"This is all it takes to improve..."</i>
                                post.
                            </p>
                            <p class="text-sm color-contrast-medium margin-top-xxxs">
            ...
            <li class="notif__item">
                <a class="notif__link flex padding-sm" href="#0">
                    ...
                    <div class="flex-grow margin-right-xs">
                        <div>
                            <p>
                                It's <i class="font-semibold">David Smith</i>'s birthday. Wish
                                him well!
                            </p>
                            <p class="text-sm color-contrast-medium margin-top-xxxs">
            ...
            <li class="notif__item">
                <a class="notif__link flex padding-sm" href="#0">
                    ...
                    <div class="flex-grow margin-right-xs">
                        <div>
                            <p>
                                <i class="font-semibold">Marta Rossi</i> posted
                                <i class="font-semibold">"10 helpful tips to learn web design"</i>.
                            </p>
                            <p class="text-sm color-contrast-medium margin-top-xxxs">
                                <time>a day ago</time>
                            </p>
                            ...
                            <div class="bg radius-md padding-sm shadow-sm margin-top-sm">
                                <p class="color-contrast-medium line-height-lg">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                    Harum beatae commodi quibusdam officiis...
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- modal window -->
    <div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal"
        id="modal-new-customer">
        <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog"
            ...
            <div class="padding-md">
                <form>
                    <div class="grid gap-sm">
                        <div class="col-12">
                            <label class="form-label margin-bottom-xxs" for="modal-customer-name">Name</label>
                            <input class="form-control width-100%" type="text" name="modal-customer-name"
                                id="modal-customer-name" required />
                        </div>

                        <div class="col-12">
                            <label class="form-label margin-bottom-xxs" for="modal-customer-email">Email</label>
                            <input class="form-control width-100%" type="email" name="modal-customer-email"
                                id="modal-customer-email" required />
                        </div>

                        <div>
                            <p class="form-label margin-bottom-sm">Status</p>
                            <ul class="flex flex-wrap gap-sm">
                                <li>
                                    <input class="radio" type="radio" name="modal-customer-status"
                                        id="modal-customer-status-free" checked />
                                    <label for="modal-customer-status-free">Free</label>
                                </li>

                                <li>
                                    <input class="radio" type="radio" name="modal-customer-status"
                                        id="modal-customer-status-pro" />
                                    <label for="modal-customer-status-pro">Pro</label>
                                </li>
                            </ul>
                        </div>
                    </div>
